...
<html lang="en">
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<nav class="navbar navbar-expand-lg fixed-top">
			<div class="container">
				<a class="navbar-brand" href="#">School Sync</a>
								...
								<div class="d-sm-flex justify-content-between">
									<div data-aos="zoom-in-up">
										<div class="banner-title">
												<h3 class="font-weight-medium">School Sync
											</h3>
										</div>
										<p class="mt-3">Sekolah maju, pakai aku!
											<br>
											Manajemen berita, aktifitas dan jadwal dengan ringkas.
										</p>
										<a href="login" class="btn btn-secondary mt-3">Login</a>
									</div>
									<div class="mt-5 mt-lg-0">
										<img src="home/images/group.png" alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
									</div>
								</div>
							</div>
						</div>
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="d-flex justify-content-between align-items-center">
						<div class="d-flex align-items-center">
						School Sync</br>
							<p class="mb-0 text-small pt-1">© 2023 <a href="https://davinwardana.com" class="text-white" target="_blank">Davin Wardana</a>. All rights reserved.</p>
