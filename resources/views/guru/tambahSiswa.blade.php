...
--> 
                    <form action="{{ route('siswa.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="nis" id="nis" class="mt-1 p-2 border rounded-md w-full" required>
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('siswa.daftarSiswa') }}" class="btn btn-dark">Back</a>
                            <x-primary-button class="ml-4" type="submit">Tambah Siswa</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
